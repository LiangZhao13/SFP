# -*- coding: utf-8 -*-
"""
Created on Sat Oct 12 17:34:06 2024
...
import numpy as np
import attr
from class_wave_resistance_estimatoin import wave_resistance
from class_wind_resistance_estimatoin import wind_resistance
...
def speed_to_power(v, heading_ship,h_waterdepth,
    ...
    r_calm = calm_resistance(V_shallow,heading_ship,h_waterdepth,
                       currentU, currentV)
    r_wind = wind_resistance(v, windU, windV, heading_ship,ship)
    r_wave = wave_resistance(V_water, Hs, Tp, Hdg, heading_ship,ship)

    r_total = (r_calm + r_wind + r_wave) / 1000
    # r_total=r_calm/1000
    etaR = 1.0
    etaO = 0.52
    etaS = 0.99
...
if __name__=='__main__':
    ...
    windU, windV=4, 2 #风两个方向的速度 m/s
    Hs, Tp, Hdg=4, 8, 40 #有效浪高m, 波峰周期s, 浪的方向
